...
public:
	...
	inline int Length() const							{ return static_cast<int>(strlen(s)); }
...
public:
	...
	bool Append(const char *ins, int ins_len = TB_ALL_TO_TERMINATION)	{ return Insert(static_cast<int>(strlen(s)), ins, ins_len); }
